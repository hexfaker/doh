...
Original implementation https://github.com/MrMino/dockernel/blob/master/dockernel/kernelspec.py by MrMino
"""
...
def ensure_kernelspec_store_exists(kernelspec_store: Path) -> None:
    ...
    kernelspec_store.mkdir(exist_ok=True, parents=True)
